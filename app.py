...
# 1. 웹 화면 및 폰트/스타일, 자동번역 차단 설정 (복구 완료 🚨)
...
if data_to_process:
    ...
    if all_records:
        ...
        with tab1:
            ...
            # 🚨 [복구 완료] 비가동시간 BEST 3 / WORST 3 추적 기능
        ...
        with tab3:
            ...
            if all_dates_rev:
                ...
                # 🚨 [복구 완료] Tab 3에 설비별 비가동 시간 비교 그래프 추가
                st.write("---")
